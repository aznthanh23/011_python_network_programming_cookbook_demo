...
def print_packet(pktlen, data, tiemstamp):
...
def main():
    ...
    parser = argparse.ArgumentParser(decription='Packet Sniffer')
    ...
    try:
        ...
        print 'Packet statistics: %d packets received, %d packets dropped, %d packets dropped byt interface' % pc.stats()
